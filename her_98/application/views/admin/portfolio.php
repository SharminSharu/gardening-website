        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
              <form action="<?php echo base_url('Welcome/port_ad') ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                <div class="row">
                <div class="col-6">
                ...
                <table class="table table-bordered">
                    ...
                    <?php foreach ($port as $k => $v) { ?>
                        <tr>
                            ...
                            <a href="<?php echo base_url('Welcome/port_del/'.$v->id) ?>" class="btn btn-xs btn-danger" onclick="return confirm('Are you sure?')" >
