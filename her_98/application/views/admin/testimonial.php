...
<div class="content-wrapper">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
              <form action="<?php echo base_url('Welcome/test_ad') ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                <div class="row">
                <div class="col-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="desig" class="form-control" id="exampleInputEmail1" placeholder="Enter Designation " >
                    </div>
    ...
    <div class="card card-primary card-outline">
              <div class="card-header bg-primary">
                <h4 class="m-0">Testimonial List</h4>
...
<td>
    ...
    <a href="<?php echo base_url('Welcome/test_del/'.$v->id) ?>" class="btn btn-danger btn-xs" onclick="return confirm('Are You Sure?')">
